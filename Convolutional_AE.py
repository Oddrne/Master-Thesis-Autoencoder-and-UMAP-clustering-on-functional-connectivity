...
class DCEC(nn.Module):
    ...
    Assumes input images of shape (1, 400, 400), e.g. FC matrices.
    """
...
def pretrain_cae(
    ...
    mask = make_upper_triangle_mask(n=400, include_diagonal=False, device=device).unsqueeze(0)  # Shape (1, 1000, 1000)
    #mse_loss = nn.MSELoss()
